...
# app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+mysqlconnector://root:testdb1234@localhost:13306/testdb"
...
def get_origininfo(story_id):
    ...
    return jsonify([{
        "story_id": origininfo.story_id,
        "content": origininfo.content,
        "origin_content": origininfo.origin_content,
        "origin_title": origininfo.origin_title,
        "origin_url": origininfo.origin_url,
